...
export default function DeleteProjectButton({ projectId, projectTitle }: DeleteProjectButtonProps) {
  ...
  return (
    <button
      ...
      disabled={isDeleting}
      className="p-2 text-zinc-500 hover:text-red-500 hover:bg-red-950/20 border border-transparent hover:border-red-900/30 rounded-lg transition-all cursor-pointer shrink-0 disabled:opacity-50"
      title="Hapus Proyek"
