...
export default function BlockPicker({ onSelectBlock }: BlockPickerProps) {
  return (
    <div className="p-3 bg-zinc-950 border border-zinc-800 rounded-xl shadow-2xl w-72 flex flex-col gap-1">
      <p className="text-[10px] font-bold tracking-widest text-zinc-500 uppercase px-2 py-1">Pilih Tipe Blok</p>
      {BLOCK_TYPES.map((block) => {
        ...
        return (
          <button
            ...
            onClick={() => onSelectBlock(block.value)}
